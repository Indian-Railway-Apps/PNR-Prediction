...
public class GCMIntentService extends GCMBaseIntentService {
	...
	protected void onRegistered(Context context, String regId) {
		...
		PPApplication.getInstance().setContext(getApplicationContext());
		
		if(regId == null || regId.contentEquals("")){
			return;
		}
		
		Log.v(PPApplication.TAG, "Registration with GCM success");
		PPApplication.getInstance().addParameter("RegistrationId", regId);
	...
	protected void onUnregistered(Context context, String regId) {
		...
		Log.v(PPApplication.TAG, "Un-Registration with GCM success");
		PPApplication.getInstance().addParameter("RegistrationId", "");
